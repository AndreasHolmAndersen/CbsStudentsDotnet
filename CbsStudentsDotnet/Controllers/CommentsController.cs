...
namespace CbsStudentsDotnet.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public CommentsController(CbsStudentContext context)
        {
            _context = context;
        }
        ...
        {
            var cbsStudentContext = _context.Comment.Include(c => c.Post);
            return View(await cbsStudentContext.ToListAsync());
        }
